  ...
  return (
    <main className="min-h-screen bg-gray-900">
      ...
      <section className="py-16 px-4 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-amber-300">Travel Tips</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Plan Ahead */}
            <div data-aos="fade-up" data-aos-delay="100" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Plan Ahead</h3>
              <p className="text-gray-300">Planning a trip in advance will give you enough time to research and plan your destination and save you money.</p>
            </div>

            {/* Pack Light */}
            <div data-aos="fade-up" data-aos-delay="150" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Pack Light</h3>
              <p className="text-gray-300">When you pack light, you&apos;ll have more freedom to travel and easily maneuver through crowded spots.</p>
            </div>

            {/* Stay Connected */}
            <div data-aos="fade-up" data-aos-delay="200" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Stay Connected</h3>
              <p className="text-gray-300">Please ensure your mobile phone has an internet connection so you can stay in touch with your family and friends, plan your itinerary better, and stay safe and secure.</p>
            </div>

            {/* Secure Your Documents */}
            <div data-aos="fade-up" data-aos-delay="250" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Secure Your Documents</h3>
              <p className="text-gray-300">When traveling, use accessories like a crossbody bag or purse to keep your documents close and secure.</p>
            </div>

            {/* Health Precautions */}
            <div data-aos="fade-up" data-aos-delay="300" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Health Precautions</h3>
              <p className="text-gray-300">Schedule an appointment with your healthcare provider at least a month before your departure for destination-specific vaccines, medicines, and advice.</p>
            </div>

            {/* Local Etiquette */}
            <div data-aos="fade-up" data-aos-delay="350" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Local Etiquette</h3>
              <p className="text-gray-300">Every country has its unique culture, and understanding local etiquette enhances your first impression, making your trip more enjoyable and successful.</p>
            </div>

            {/* Stay Safe */}
            <div data-aos="fade-up" data-aos-delay="400" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Stay Safe</h3>
              <p className="text-gray-300">Protect your money, phone, and passport. Above all else, protect all three. Possessing these three can replace everything else. If you lose one, the other two can help you replace the lost item.</p>
            </div>

            {/* Insurance */}
            <div data-aos="fade-up" data-aos-delay="450" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Insurance</h3>
              <p className="text-gray-300">Insurance can reduce the significant financial risks associated with travel, including accidents, illness, missed flights, canceled tours, lost baggage, theft, etc.</p>
            </div>

            {/* Be Flexible and Open-Minded */}
            <div data-aos="fade-up" data-aos-delay="500" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Be Flexible and Open-Minded</h3>
              <p className="text-gray-300">Traveling with an open mind lets you fully immerse yourself in new cultures, ideas, and lifestyles.</p>
            </div>

            {/* Money Management */}
            <div data-aos="fade-up" data-aos-delay="550" className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] border-t-2 border-amber-300">
              <div className="flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-100 text-center">Money Management</h3>
              <p className="text-gray-300">Creating a travel budget is essential to save money while traveling abroad or avoid overspending.</p>
            </div>
          </div>
        </div>
      </section>
