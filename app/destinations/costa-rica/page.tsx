    ...
    return (
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                {activeTab === 'packages' && (
                    <div className="space-y-8">
                        <h2 className="text-3xl font-bold text-[#0e3b7c] mb-6">Costa Rica Tourism Packages</h2>
                ...
                {activeTab === 'tips' && (
                    <div className="space-y-8">
                        <h2 className="text-3xl font-bold text-[#0e3b7c] mb-6">Costa Rica Tourism Tips</h2>
                        ...
                        <div className="bg-gradient-to-r from-[#0e3b7c] to-[#0a2d5e] rounded-lg shadow-xl overflow-hidden mt-8">
                            <div className="px-6 py-8 md:p-8 text-white">
                                ...
                                <p className="mb-6">Our Costa Rica tourism specialists can provide personalized advice and help you plan the perfect trip.</p>
                                <Link
                                    href="/contact"
