            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                        ...
                        {isLoggedIn ? (
                            <Link href="/account" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600">
                                My Account
                            </Link>
                        ) : (
                            <Link
            ...
            {isMenuOpen && (
                <div className="md:hidden">
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        {isLoggedIn ? (
                            <Link href="/account" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50">
                                My Account
                            </Link>
                        ) : (
                            <Link
